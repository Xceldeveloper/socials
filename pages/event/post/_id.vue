    ...
    <div id="post-content-wrapper">
      <div id="post-content">
        <div id="image-cover" ref="imgcover">
              <v-btn :color="Colors.textTure" absolute :top="isMobile ? false : true" :left="isMobile ? false : true" :right="!isMobile ? false : true" :bottom="!isMobile ? false : true"   fab @click="gotoEvents">
        ...
        <div id="post-details">
          ...
          <div id="event-wrapper">
            <div id="event">
              <div id="cov">
                ...
                <span id="event-countdown" @click="countDownTime = !countDownTime">
                     <v-icon :color="Colors.text">mdi-clock-outline</v-icon>
                 {{getCountDown}}
                </span>
                 <span id="event-more-details" v-html="formatedDetails">
                </span>
              </div>
            </div>
          </div>
          ...
          <div id="action-btns">
              <div id="promoted-btn-cover">
              <v-btn
                :color="Colors.text"
                :rounded="isMobile ? false : true"
                width="80%" outlined small
              >Are you Interested ?</v-btn>
            </div>
            <v-btn
              icon
...
export default {
  ...
  data() {
    return {
      ...
      reposted: false,
      reminder: false,
      eventTitle:'Covid 19 Virtual Conference',
      eventLocation:'Slack Channel ce2345',
      eventTime: "Wed June 10 2020 17:06:03 GMT+0100",
      eventMoreDetails:"CDC, WHO,AWHO, UNICEF,\n Donal Trump \n Putin \n Bubu  ",
  ...
  computed: {
    ...
    formatedDetails() {
      var text = "";
      text = this.formatText(this.eventMoreDetails);
      return text;
    },
       getCountDown() {
      var date = this.eventTime;
