<template>
  <div id="newvideo" :style="{backgroundColor:read ? Colors.textTure : Colors.background,borderRadius:borderRadius}">
    <style>
       :root{
    ...
    <div id="details-cover" v-if="!loading">
      <span class="message">
        ...
        <span v-if="count < 2">a video...</span>
         <span v-if="count > 1"> videos...</span>
      </span>
