<template>
  <div id="newtag" :style="{backgroundColor:read ? Colors.textTure : Colors.background,borderRadius:borderRadius}">
    <style>
       :root{
    ...
    <div id="details-cover" v-if="!loading">
      <span class="message">
        <span class="username">{{username}}</span> Tagged you in a {{type}} post
      </span>
